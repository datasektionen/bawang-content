...
Sektionen har flera styrande dokument. De allra flesta hittar du på [styrdokumentssidan](//styrdokument.datasektionen.se). Utöver de fasta styrdokumenten har vi även planeringsdokument som beskriver hur verksamheten ska se ut det närmsta året. Dessa är [verksamhetsplanen](/organisation/verksamhetsplan) och [budgeten](/organisation/budget). Vi har även ett [Samboendeavtal](http://static.datasektionen.se/organisation/samboendeavtal2019.pdf) som styr hur META delas mellan Datasektionen och Sektionen för Medieteknik.
